...
fn test_pcmpeqb_all_different() {
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x6f, 0x0c, 0x25, 0x08, 0x20, 0x00,
        0x00, 0x0f, 0x74, 0xc1, 0x0f, 0x7f, 0x04, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqb_mm_m64() {
    let code = vec![
        0x0f, 0x6f, 0x14, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x74, 0x14, 0x25, 0x08, 0x20, 0x00,
        0x00, // PCMPEQB MM2, [0x2008]
...
fn test_pcmpeqb_mm5_mm6() {
    let code = vec![
        ...
        0x00, 0x0f, 0x74, 0xee, // PCMPEQB MM5, MM6
...
fn test_pcmpeqb_self() {
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x74, 0xc0, // PCMPEQB MM0, MM0
        0x0f, 0x7f, 0x04, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqw_all_different() {
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x6f, 0x0c, 0x25, 0x08, 0x20, 0x00,
        0x00, 0x0f, 0x75, 0xc1, 0x0f, 0x7f, 0x04, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqw_mm_m64() {
    let code = vec![
        0x0f, 0x6f, 0x14, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x75, 0x14, 0x25, 0x08, 0x20, 0x00,
        0x00, // PCMPEQW MM2, [0x2008]
        0x0f, 0x7f, 0x14, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqw_mm7_mm0() {
    let code = vec![
        ...
        0x00, 0x0f, 0x75, 0xf8, // PCMPEQW MM7, MM0
...
fn test_pcmpeqw_self() {
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x75, 0xc0, // PCMPEQW MM0, MM0
        0x0f, 0x7f, 0x04, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqd_all_different() {
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x6f, 0x0c, 0x25, 0x08, 0x20, 0x00,
        0x00, 0x0f, 0x76, 0xc1, 0x0f, 0x7f, 0x04, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqd_mm_m64() {
    let code = vec![
        0x0f, 0x6f, 0x14, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x76, 0x14, 0x25, 0x08, 0x20, 0x00,
        0x00, // PCMPEQD MM2, [0x2008]
        0x0f, 0x7f, 0x14, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_pcmpeqd_mm4_mm3() {
    let code = vec![
        0x0f, 0x6f, 0x24, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x6f, 0x1c, 0x25, 0x08, 0x20, 0x00,
        0x00, 0x0f, 0x76, 0xe3, // PCMPEQD MM4, MM3
...
fn test_pcmpeqd_self() {
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x76, 0xc0, // PCMPEQD MM0, MM0
        0x0f, 0x7f, 0x04, 0x25, 0x10, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_all_compare_sizes() {
    ...
    let code = vec![
        ...
        0x00, 0x00, 0x0f, 0x6f, 0x24, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x6f, 0x2c, 0x25, 0x08,
        0x20, 0x00, 0x00, 0x0f, 0x74, 0xc1, // PCMPEQB MM0, MM1
        ...
        0x00, 0x0f, 0x7f, 0x24, 0x25, 0x20, 0x20, 0x00, 0x00, 0xf4,
    ];
...
fn test_compare_as_mask() {
    ...
    let code = vec![
        0x0f, 0x6f, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00, 0x0f, 0x6f, 0x0c, 0x25, 0x08, 0x20, 0x00,
        0x00, 0x0f, 0x6f, 0x14, 0x25, 0x10, 0x20, 0x00, 0x00, 0x0f, 0x74,
        0xc1, // PCMPEQB MM0, MM1 (result = mask)
