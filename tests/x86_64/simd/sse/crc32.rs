...
fn test_crc32_r64_r64_basic() {
    let code = [
        0x48, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // MOV RAX, 0
        0x48, 0xb9, 0x78, 0x56, 0x34, 0x12, 0xef, 0xcd, 0xab,
        0x90, // MOV RCX, 0x90ABCDEF12345678
...
fn test_crc32_r64_different_registers() {
    let code = [
        ...
        0x48, 0xba, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x00,
        0x11, // MOV RDX, 0x1100FFEEDDCCBBAA
...
fn test_crc32_r64_same_register() {
    let code = [
        0x48, 0xb8, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde,
        0xf0, // MOV RAX, 0xF0DEBC9A78563412
...
fn test_crc32_mem_sib() {
    ...
    mem.write_slice(&actual_data, vm_memory::GuestAddress(ALIGNED_ADDR + 8))
        .unwrap();
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_crc32_r64_with_r10_r11() {
    let code = [
        ...
        0x49, 0xbb, 0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32,
        0x10, // MOV R11, 0x1032547698BADCFE
...
fn test_crc32_string_test123() {
    let code = [
        0xb8, 0x00, 0x00, 0x00, 0x00, // MOV EAX, 0
        0xb1, 0x74, // 't'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xb1, 0x65, // 'e'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xb1, 0x73, // 's'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xb1, 0x74, // 't'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xb1, 0x31, // '1'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xb1, 0x32, // '2'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xb1, 0x33, // '3'
        0xf2, 0x0f, 0x38, 0xf0, 0xc1, 0xf4,
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
