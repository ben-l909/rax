...
fn test_phsubw_xmm0_mem() {
    ...
    let data: [u8; 16] = [
        0x0A, 0x00, 0x05, 0x00, 0x14, 0x00, 0x08, 0x00, 0x1E, 0x00, 0x0C, 0x00, 0x28, 0x00, 0x10,
        0x00,
    ];
...
fn test_phsubw_xmm1_mem_negative() {
    ...
    let data: [u8; 16] = [
        0x01, 0x00, 0x0A, 0x00, 0x02, 0x00, 0x14, 0x00, 0x03, 0x00, 0x1E, 0x00, 0x04, 0x00, 0x28,
        0x00,
    ];
    mem.write_slice(&data, vm_memory::GuestAddress(ALIGNED_ADDR))
        .unwrap();
...
fn test_phsubd_xmm0_mem() {
    ...
    let data: [u8; 16] = [
        0x0A, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
        0x00,
    ];
    mem.write_slice(&data, vm_memory::GuestAddress(ALIGNED_ADDR))
        .unwrap();
...
fn test_phsubd_xmm1_mem_negative() {
    ...
    let data: [u8; 16] = [
        0x01, 0x00, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00,
        0x00,
    ];
    mem.write_slice(&data, vm_memory::GuestAddress(ALIGNED_ADDR))
        .unwrap();
...
fn test_phsubw_mem_displacement() {
    ...
    mem.write_slice(
        &[
            0x05, 0x00, 0x03, 0x00, 0x05, 0x00, 0x03, 0x00, 0x05, 0x00, 0x03, 0x00, 0x05, 0x00,
            0x03, 0x00,
        ],
...
fn test_phsubd_mem_displacement() {
    ...
    mem.write_slice(
        &[
            0x05, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x00,
            0x00, 0x00,
        ],
        vm_memory::GuestAddress(ALIGNED_ADDR),
    )
