...
fn test_pmulhuw_all_ones() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x6f, 0x0b, 0x66, 0x0f, 0xe4, 0xc1, 0xf4,
    ]);
...
fn test_pmulhuw_from_memory() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0xe4, 0x03, // PMULHUW XMM0, [RBX]
        0xf4,
    ]);
...
fn test_pmulhuw_alternating_values() {
    ...
    mem.write_slice(
        &[
            0xFF, 0xFF, 0x01, 0x00, 0xFF, 0xFF, 0x01, 0x00, 0xFF, 0xFF, 0x01, 0x00, 0xFF, 0xFF,
            0x01, 0x00,
        ],
        GuestAddress(ALIGNED_ADDR),
    )
    ...
    mem.write_slice(
        &[
            0x01, 0x00, 0xFF, 0xFF, 0x01, 0x00, 0xFF, 0xFF, 0x01, 0x00, 0xFF, 0xFF, 0x01, 0x00,
            0xFF, 0xFF,
        ],
        GuestAddress(ALIGNED_ADDR2),
    )
