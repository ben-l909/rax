...
fn test_pmaxsb_positive_negative() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x6f, 0x0b, 0x66, 0x0f, 0x38, 0x3c, 0xc1, 0xf4,
    ]);
...
fn test_pmaxsw_all_zeros() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x6f, 0x0b, 0x66, 0x0f, 0xee,
        0xc1, // PMAXSW XMM0, XMM1
        0xf4,
    ]);
...
fn test_pmaxsw_positive_negative() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x6f, 0x0b, 0x66, 0x0f, 0xee, 0xc1, 0xf4,
    ]);
...
fn test_pmaxsw_negative_values() {
    ...
    mem.write_slice(
        &[
            0xFE, 0xFF, 0xFE, 0xFF, 0xFE, 0xFF, 0xFE, 0xFF, 0xFE, 0xFF, 0xFE, 0xFF, 0xFE, 0xFF,
            0xFE, 0xFF,
        ],
        GuestAddress(ALIGNED_ADDR2),
    )
...
fn test_pmaxsw_from_memory() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0xee, 0x03, // PMAXSW XMM0, [RBX]
        0xf4,
    ]);
...
fn test_pmaxsd_all_zeros() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x6f, 0x0b, 0x66, 0x0f, 0x38, 0x3d,
        0xc1, // PMAXSD XMM0, XMM1
        0xf4,
    ]);
...
fn test_pmaxsd_positive_negative() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x6f, 0x0b, 0x66, 0x0f, 0x38, 0x3d, 0xc1, 0xf4,
    ]);
...
fn test_pmaxsd_from_memory() {
    ...
    full_code.extend_from_slice(&ALIGNED_ADDR2.to_le_bytes());
    full_code.extend_from_slice(&[
        0x66, 0x0f, 0x6f, 0x00, 0x66, 0x0f, 0x38, 0x3d, 0x03, // PMAXSD XMM0, [RBX]
        0xf4,
    ]);
