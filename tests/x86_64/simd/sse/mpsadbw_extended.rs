...
fn test_mpsadbw_xmm2_xmm4_offset_0() {
    // MPSADBW XMM2, XMM4, 0
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xd4, 0x00, 0xf4, // HLT
    ];
...
fn test_mpsadbw_xmm3_xmm5_offset_1() {
    // MPSADBW XMM3, XMM5, 1
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xdd, 0x01, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm4_xmm6_offset_2() {
    // MPSADBW XMM4, XMM6, 2
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xe6, 0x02, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm5_xmm7_offset_3() {
    // MPSADBW XMM5, XMM7, 3
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xef, 0x03, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm6_xmm0_offset_4() {
    // MPSADBW XMM6, XMM0, 4
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xf0, 0x04, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm7_xmm1_offset_5() {
    // MPSADBW XMM7, XMM1, 5
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xf9, 0x05, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm0_xmm2_offset_6() {
    // MPSADBW XMM0, XMM2, 6
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xc2, 0x06, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm1_xmm3_offset_7() {
    // MPSADBW XMM1, XMM3, 7
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xcb, 0x07, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm8_xmm10_offset_0() {
    ...
    let code = [
        0x66, 0x45, 0x0f, 0x3a, 0x42, 0xc2, 0x00, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm9_xmm12_offset_1() {
    ...
    let code = [
        0x66, 0x45, 0x0f, 0x3a, 0x42, 0xcc, 0x01, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm11_xmm14_offset_2() {
    ...
    let code = [
        0x66, 0x45, 0x0f, 0x3a, 0x42, 0xde, 0x02, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm13_xmm15_offset_3() {
    ...
    let code = [
        0x66, 0x45, 0x0f, 0x3a, 0x42, 0xef, 0x03, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm15_xmm8_offset_4() {
    ...
    let code = [
        0x66, 0x45, 0x0f, 0x3a, 0x42, 0xf8, 0x04, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm0_xmm8_offset_5() {
    // MPSADBW XMM0, XMM8, 5
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xc0, 0x05, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm1_xmm9_offset_6() {
    // MPSADBW XMM1, XMM9, 6
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xc9, 0x06, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm2_xmm10_offset_7() {
    ...
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xd2, 0x07, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm3_xmm11_offset_0() {
    ...
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xdb, 0x00, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm4_xmm12_offset_1() {
    ...
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xe4, 0x01, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm5_xmm13_offset_2() {
    ...
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xed, 0x02, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm6_xmm14_offset_3() {
    ...
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xf6, 0x03, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm7_xmm15_offset_4() {
    ...
    let code = [
        0x66, 0x41, 0x0f, 0x3a, 0x42, 0xff, 0x04, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm8_xmm0_offset_5() {
    // MPSADBW XMM8, XMM0, 5
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xc0, 0x05, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm9_xmm1_offset_6() {
    // MPSADBW XMM9, XMM1, 6
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xc9, 0x06, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm10_xmm2_offset_7() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xd2, 0x07, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm11_xmm3_offset_0() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xdb, 0x00, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm12_xmm4_offset_1() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xe4, 0x01, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm13_xmm5_offset_2() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xed, 0x02, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm14_xmm6_offset_3() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xf6, 0x03, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_xmm15_xmm7_offset_4() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xff, 0x04, 0xf4, // HLT
    ];
    let (mut vcpu, _) = setup_vm(&code, None);
    run_until_hlt(&mut vcpu).unwrap();
}
...
fn test_mpsadbw_sequential_offsets() {
    ...
    let code = [
        0x66, 0x0f, 0x3a, 0x42, 0xc1, 0x00, // MPSADBW XMM0, XMM1, 0
...
fn test_mpsadbw_all_high_regs_pattern() {
    ...
    let code = [
        0x66, 0x45, 0x0f, 0x3a, 0x42, 0xc1, 0x00, // MPSADBW XMM8, XMM9, 0
...
fn test_mpsadbw_cross_boundary_mix() {
    ...
    let code = [
        0x66, 0x44, 0x0f, 0x3a, 0x42, 0xc7, 0x01, // MPSADBW XMM8, XMM7, 1
